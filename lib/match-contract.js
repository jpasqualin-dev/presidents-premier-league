...
const { longTeamName } = require('./team-names');
...
function normalizeEspnEvent(event) {
    ...
    return {
        ...
        homeTeam: { id: String(home.team.id), name: longTeamName(home.team.displayName, home.team.id), crest: home.team.logo || null },
        awayTeam: { id: String(away.team.id), name: longTeamName(away.team.displayName, away.team.id), crest: away.team.logo || null },
        score: {
            fullTime: {
...
function normalizeNeonMatch(row) {
    ...
    return {
        ...
        homeTeam: { id: row.home_provider_id, name: longTeamName(row.home_name, row.home_provider_id), crest: row.home_logo },
        awayTeam: { id: row.away_provider_id, name: longTeamName(row.away_name, row.away_provider_id), crest: row.away_logo },
        score: {
