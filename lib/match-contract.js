...
function normalizeEspnEvent(event) {
    ...
    return {
        ...
        homeTeam: { id: String(home.team.id), name: longTeamName(home.team.displayName, home.team.id), crest: crestForTeam(home.team.displayName, home.team.id) },
        awayTeam: { id: String(away.team.id), name: longTeamName(away.team.displayName, away.team.id), crest: crestForTeam(away.team.displayName, away.team.id) },
        score: {
            fullTime: {
...
function normalizeNeonMatch(row) {
    ...
    return {
        ...
        homeTeam: { id: row.home_provider_id, name: longTeamName(row.home_name, row.home_provider_id), crest: crestForTeam(row.home_name, row.home_provider_id) },
        awayTeam: { id: row.away_provider_id, name: longTeamName(row.away_name, row.away_provider_id), crest: crestForTeam(row.away_name, row.away_provider_id) },
        score: {
