(() => {
    ...
    const applyNavigationTemplate = () => {
        ...
        navigationStyles.textContent = `
            ...
            .site-menu { position: sticky; top: 0; z-index: 20; height: auto; padding: 18px 3px 16px; margin-bottom: 0; background: #ffffff; border: 0; border-radius: 0; box-shadow: none; }
