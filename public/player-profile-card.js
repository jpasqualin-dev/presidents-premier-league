(function () {
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        chevron.type = 'button';
        chevron.setAttribute('aria-label', 'Toggle profile details');
