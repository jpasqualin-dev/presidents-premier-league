(function () {
    ...
    style.textContent += '.team-drawer-card-title{margin-top:0;margin-bottom:16px;border-bottom:2px solid #00ff87;padding-bottom:8px}.team-drawer-records{min-width:0}.team-drawer-record{min-width:0;margin-left:5ch}.team-drawer-record>span,.team-drawer-record>strong{min-width:0}.team-drawer-rank-pick{display:flex;justify-content:space-between;gap:12px}.team-drawer-rank-pick span{min-width:0;white-space:normal}.team-drawer-draft-diff{color:inherit;font:inherit}.team-drawer-chevron{color:var(--text-muted,#718096);font-size:.85rem;transition:transform .25s ease}.team-drawer-player-card.expanded .team-drawer-chevron{transform:rotate(90deg)}';
