(function () {
    ...
    style.textContent += '.team-drawer-card-title{margin-top:0;margin-bottom:16px;border-bottom:2px solid #00ff87;padding-bottom:8px}.team-drawer-records{min-width:210px}.team-drawer-record{margin-inline:5ch}.team-drawer-rank-pick{display:flex;justify-content:space-between;gap:18px}.team-drawer-rank-pick span{white-space:nowrap}';
    ...
    function render(teamName, options) {
        ...
        const draftPick = `${draftPickValue} (${draftDiff >= 0 ? '+' : ''}${draftDiff})`;
